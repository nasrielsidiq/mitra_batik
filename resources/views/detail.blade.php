	...
	<div class="product_image_area mt-5">
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6" style="height: 500px; overflow:hidden;">
                        <img class="img-fluid" src="{{asset('/storage/image/'.$item->image)}}" style="object-fit: cover" alt="">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>{{$item->name}}</h3>
						<h2>Rp. {{number_format($item->cost,2,',','.')}}</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : {{$item->type->name}}</a></li>
							<li><a href="#"><span>Availibility</span> : {{$item->stocks}}</a></li>
						</ul>
						...
						<div class="col-lg-6">
							<div class="comment_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="{{asset('img/product/review-1.pn')}}g" alt="">
										</div>
